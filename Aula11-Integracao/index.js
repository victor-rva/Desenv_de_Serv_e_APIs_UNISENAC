...
const corsMidlleware = require('restify-cors-middleware2'); //Para fazer requisição AJAX no front-end precisa utilizar o corsMiddleware
...
servidor.put('/produtos/update/:idProd', (req, res, next) => {
